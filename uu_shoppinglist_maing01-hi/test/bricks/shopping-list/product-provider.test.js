...
describe(`UuShoppinglist.Bricks.ShoppingList.ProductProvider`, () => {
  // it("onLoad", async () => {
  //   let onLoad = jest.fn(async () => ({ content: "Hello, world!" }));
  //   let loadDtoIn = { foo: "bar" };
  //   let wrapper = mount(<UuShoppinglist.Bricks.ShoppingList.ProductProvider onLoad={onLoad} loadDtoIn={loadDtoIn} />);
